...
<html lang="en">
  ...
  <center>
    ...
    <?php echo "<script> showAlert('$errormsg') </script>"; ?>
      <div class="mainLoginClass d-flex" style="height:100vh; background-color:black; align-items: center;">
        <div class="animationclass w-50">
                  
                   <?php include_once "animation.html"; ?>
        </div>
        <div class="formClass w-50 d-flex flex-column "  >
                    <div class="loginformcard" id="card1" style="background-color:black; color: white;">
