...
<html lang="en">
  ...
  ?>
  <body class="violetgradient" style=" background-image: url('images/honeycomb.png'); background-color: black;">
    <?php
    include "navbar.php"
    ?>
    <center>
    ...
    <div>
      <center>
		...
		<i class='fa fa-qrcode'></i> Scan QR
          ...
          <span style="color:red;font-weight:bold">WARNING:</span> <span style="font-weight:bold">COUNTERFEIT PRODUCT DETECTED !! please report to the product owner..</span>
          </p>
        </div>
      </center>
    </div>
